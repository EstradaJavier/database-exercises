...
JOINS: Use when you want to combine information across multiple tables
...
# equivalent to this... we are using the result-set to build this table
SELECT *
FROM departments
WHERE dept_no = 'd009';
